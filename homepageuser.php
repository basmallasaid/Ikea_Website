    ...
    <nav class="navbar bg-body-tertiary">
        <div class="container-fluid">
          ...
          <form class="d-flex" role="search">
            ...
            <i class='bx bx-search' style="font-size: 30px; padding-top: 5px;" ></i>
          </form>
          <a href="#"><i class='bx bx-cart' style="font-size: 35px; "></i></a>
          <h5><?php echo $_SESSION['username'];
?></h5><a href="profile.php"> <i class='bx bx-user' style="font-size: 35px;"></i></a>
        </div>
      </nav>
  ...
  <a href="p1.jpg" target="_blank">
          <img src="p1.jpg" alt="Fjords" style="width:100%">
  </a>
</div> 
  <div class="card-body">
    <h5 class="card-title">Card title <span class="price"> price :<i class='bx bx-dollar' ></i><?php echo $display_news[$i+($a*3)]['price'];?></span></h5>
    <p class="card-text"><?php echo " asdsadsadsadsdsaddas ".$display_news[$i+($a*3)]['description']." asdasdsadasdasdsadadasdasdsadsadsadsadsadsadsadsadsadasd";?></p>
    
    <a href="#" class="btn btn-primary">Add to cart <i class='bx bx-cart' ></i></a>
  </div>
  </div>
...
<div class="bestseller">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><?php echo " asdsadsadsadsdsaddas ".$display_topsales[$i+($a*3)]['description']." asdasdsadasdasdsadadasdasdsadsadsadsadsadsadsadsadsadasd";?></p>
